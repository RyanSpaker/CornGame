...
fn load_corn_common_shader(mut res: ResMut<ShaderImports>, assets: Res<AssetServer>){
    res.shaders.insert("corn_game::utils::random".to_string(), assets.load::<Shader>("shaders/random/rand_common.wgsl"));
    res.shaders.insert("corn_game::utils::random::noise".to_string(), assets.load::<Shader>("shaders/random/noise.wgsl"));
    res.shaders.insert("corn_game::utils::random::simplex".to_string(), assets.load::<Shader>("shaders/random/simplex.wgsl"));
    ...
    res.shaders.insert("corn_game::corn".to_string(), assets.load::<Shader>("shaders/corn/corn_common.wgsl"));
    res.shaders.insert("corn_game::corn::wind".to_string(), assets.load::<Shader>("shaders/corn/render/wind.wgsl"));
    res.shaders.insert("corn_game::corn::vertex_io".to_string(), assets.load::<Shader>("shaders/corn/render/vertex_io.wgsl"));
}
